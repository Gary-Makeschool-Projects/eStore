...
-   To run tests.py make sure that you have the most updated version of Google Chrome, sleinium will run the chrome engine virtually test the routes. Then run the test with `python3 tests.py`.
